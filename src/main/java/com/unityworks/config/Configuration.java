...
public class Configuration {
	...
	public static void SendMailSSLWithAttachment() {
		...
		Session session = Session.getInstance(props,
				...
				new javax.mail.Authenticator() {
					...
					protected PasswordAuthentication getPasswordAuthentication() {
						...
						return new PasswordAuthentication("gaurav.sharma@123.com", "Pass");
		...
		try {
			...
			message.setFrom(new InternetAddress("gaurav.sharma@123.com"));
			...
			// set the file
			messageBodyPart2.setFileName("UnityWorksTestExecutionReport.html");
